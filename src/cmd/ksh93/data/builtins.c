...
"[o]:?[option?A \b-o\b with no \aoption\a will write the list of options and "
	...
	"{"
		...
		"[+execonsave?After using the full editor on a command line, "
			"execute only if changes have been saved.]"
...
"[+?When commands are edited (when the \b-l\b option is not specified), the "
	...
	"command and the commands that are re-executed. If \bexeconsave\b mode "
	"is enabled, the command will run only if changes have been saved. ]"
